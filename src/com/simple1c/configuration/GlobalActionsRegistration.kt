...
class GlobalActionsRegistration(val actionManager: ActionManager) : ApplicationConfigurator {
    override fun configure(container: PicoContainer) {
        ...
        registerAction(container, "1C.CancelQuery", CancelQueryAction::class.java, IdeActions.GROUP_EDITOR_POPUP)
    }
